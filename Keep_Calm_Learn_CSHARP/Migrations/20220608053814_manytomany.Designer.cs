...
namespace Keep_Calm_Learn_CSHARP.Migrations
{
    ...
    [Migration("20220608053814_manytomany")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Keep_Calm_Learn_CSHARP.Models.Student", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Keep_Calm_Learn_CSHARP.Models.Teacher", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("StudentTeacher", b =>
                {
                    b.HasOne("Keep_Calm_Learn_CSHARP.Models.Student", null)
                        .WithMany()
                        .HasForeignKey("StudentsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Keep_Calm_Learn_CSHARP.Models.Teacher", null)
                        .WithMany()
